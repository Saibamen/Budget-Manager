                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url("/password/reset") }}">
                        ...
                        <div class="form-group{{ $errors->has("password_confirmation") ? " has-error" : "" }}">
                            <label for="password-confirm" class="col-md-4 control-label">@lang("auth.password_confirmation")</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-refresh"></i> @lang("passwords.reset_password")
                                </button>
                            </div>
                        </div>
                    </form>
